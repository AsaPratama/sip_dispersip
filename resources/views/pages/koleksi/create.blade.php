                            ...
                            <div class="card-body">
                                ...
                                <form action="{{route('koleksi.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1800" max="2024" class="form-control" id="" name="tahun_terbit" value="" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" max="1000" class="form-control" id="" name="jumlah_buku" value="" required oninput="this.value = this.value.replace(/[^0-9]/g, '')" >
                                    </div>
